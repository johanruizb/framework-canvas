...
const ChangePosition = function func(world, p = ['pacman', 'blue', 'yellow', 'red', 'rose']) {
  ...
  // Izquierda
    ...
    Object.assign(character, {
      oldx: character.x % 20 == 0 ? character.x : character.direction == 37 ? character.x + 10 : character.x - 10
    });
    Object.assign(character, {
      oldy: character.y % 20 == 0 ? character.y : character.direction == 38 ? character.y + 10 : character.y - 10
    });
...
function MovingMouth(world) {
  ...
  if (world.pacman.mouth) {
    return Object.assign({}, world, {
      pacman: Object.assign(world.pacman, {
        mouth: !(world.pacman.apertura == 40),
        apertura: world.pacman.apertura + 10
      })
    });
  } else {
    return Object.assign({}, world, {
      pacman: Object.assign(world.pacman, {
        mouth: (world.pacman.apertura == 0),
        apertura: world.pacman.apertura - 10
      })
    });
  }
 ...
 */
const RoouteMaker = function func(BaseCoors = [], character, target, RouteCoors = [], sides = [
  [-20, 0],
  [0, -20],
  [20, 0],
  [0, 20]
  ...
  if (index > -1) {
    ...
    Object.assign(option, {
      steps: Math.abs(target.x - option.x) + Math.abs(target.y - option.y)
    })
